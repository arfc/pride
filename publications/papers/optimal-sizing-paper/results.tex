...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=\columnwidth]{scenario03 mga 0_ind_capacity.png}
	\caption{The projected steam capacity in MW$_{th}$ for the next 10 years if
	\gls{uiuc} invests in \glspl{smr}.}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=\columnwidth]{scenario03 mga 0_elc_generation.png}
	\caption{The projected breakdown of electricity generation in GWh(e), by
	source, for the next 10 years at \gls{uiuc}.}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=\columnwidth]{scenario03 mga 0_all_emissions.png}
