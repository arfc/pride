...
\begin{equation*}
	\text{where} \begin{cases}
		\alpha_y^{year} = &\text{construction cost at year $0$}\\
		ref_y &\text{is the size of the reference plant}
	\end{cases}
\end{equation*}