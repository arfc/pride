...
The steam demand is given in units of klbs/hr. APP currently generates steam at both 850 psi and 325 psi. The steam demand does not distinguish between these two pressures, so we assume that all of the steam generated is at 850 psi. We can convert the steam flow rate at this pressure to thermal power by 

\begin{align}
	P_{th} &= \dot{m}_{steam}c\Delta T \mbox{ [$MW_{th}$]}\\
\intertext{where}
	\dot{m} &= \mbox{ steam flow rate [lbs/hr]}\nonumber\\
