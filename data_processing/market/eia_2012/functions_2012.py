...
def generation(sheet: str = f'{path}eia_generation_2012.csv'):

    '''
    This function generates a nested dictionary of the Universities
    present in the 2012 EIA spreadsheet and their generation amounts
    ...
    --------
    gen_dict: dict
        Nested dictionary of the Universities present in the 2012 EIA
...
def university_top_producers():
    ...
    in the USA from 2012 and the amount of energy produced in MWhr.
...
def energy_type_breakdown():
    ...
    types of fuel used by the university system in the US for 2012.

    Returns:
    --------
    fuel_breakdown: dict
        This is a dictionary with keys of each fuel type used by the
        university system in the USA in 2012 and values of the amounts.
...
def university_top_renewables():
    ...
    renewable energy production in the USA in 2012.
...
def usage(sort: str = 'installed'):
    ...
    usage: str
        ...
        will be gathered from the 2012 year.
...
def plot_data(total: bool = False,
    ...
    if total is True:
        ...
        plt.title('Top Electrical Production from Education Sector (2012)')
    ...
    if top_renewables is True:
        ...
        plt.title(
            'Top Renewable Electrical Production from Education Sector (2012)'
        )
    ...
    if fuel_breakdown is True:
        ...
        plt.title('2012 Energy Breakdown in Education')
    ...
    if use is True:
        ...
        for method in plotting:
            ...
            plt.title(f'{title} Fuel Usage by Universities in 2012.')
